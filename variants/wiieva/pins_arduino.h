...
// ESP8266 pins
static const uint8_t WIIEVA_STM_RDY= ESP_PINS_OFFSET + 0;
...
static const uint8_t WIIEVA_USBPWR = 25;
...
#define isFlashInterfacePin(p)      ((p) >= (ESP_PINS_OFFSET+6) && (p) <= (ESP_PINS_OFFSET+11))
#define ESP8266_WAVEFORM_BY_DIGITALWRITE 1
