...
#define MINES_CELL_WIDTH    22      // Number of pixels
#define MINES_CELL_HEIGHT   22      // Number of pixels
#define MINES_FIELD_WIDTH   8       // Number of cells
#define MINES_FIELD_HEIGHT  9       // Number of cells
#define MINES_FLAG_DELAY    150     // Number of milliseconds
#define MINES_MINE_COUNT    15      // Around 15%-20% field/mines ratio is nice!
...
void minesStart(void)
{
    ...
    initField();
    gfxThreadCreate(0, 2048, NORMAL_PRIORITY, thdMines, 0); 
    while (!minesGameOver) {
